class Scholar::ForumsController < Scholar::BaseController
  ...
  def create
    ...
    redirect_back fallback_location: scholar_forums_path, notice: 'Crawling every forums, you can refresh your browser to read it.'
  end
  ...
  def destroy
    @forum.destroy
    redirect_to scholar_forums_url, notice: "Forum #{@forum.name} was successfully destroyed."
  end
